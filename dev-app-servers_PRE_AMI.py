...
ud = Base64(Join('', [
    ...
    "chmod +w /etc/sudoers\n",
#    "echo 'jenkins ALL=NOPASSWORD: /bin/sh' >> /etc/sudoers\n",
#    "echo 'jenkins ALL=NOPASSWORD: /usr/bin/python' >> /etc/sudoers\n",
	...
	"mkdir /app\n",
    "chown -R root:jenkins /app\n",
    "chmod 770 /app\n",
    "sudo chown root:jenkins /etc/init.d/\n",
